    ...
    private static Order takeOrder() {
        ...
        public class Main{
            public static void main(String[] args){
                ...
                switch(input){
                    case 1 :System.out.println("1.Delux pizza\n2.Cheese and Corn\n3.Panner Tikka");
                        System.out.print("SELECT ONE : ");
                        int in = sc.nextInt();
                        switch(in){
                            case 1 : System.out.println("Regular: Rs. 150  Medium: Rs. 200  Large: Rs. 325");
                                break;
                            case 2 : System.out.println("Regular: Rs. 175 Medium: Rs. 375 Large: Rs. 475");
                                break;
                            case 3 : System.out.println("Regular: Rs. 160 Medium: Rs. 290 Large: Rs. 340");
                                break;
                        }
                    ...
                    case 2 : System.out.println("1.Non-Veg Supreme\n2.Chicken Tikka\n3.Pepper Barbecue");
                        System.out.print("SELECT ONE");
                        int ind = sc.nextInt();
                        switch(ind){
                            case 1 : System.out.println("Regular: Rs 190 Medium: Rs 325 Large: Rs 425");
                                break;
                            case 2 : System.out.println("Regular: Rs 210 Medium: Rs 370 Large: Rs 500");
                                break;
                            case 3 : System.out.println("Regular: Rs 220 Medium: Rs 380 Large: Rs 525");
                                break;
                        }
